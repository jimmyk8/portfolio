...
function portfolio_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control( $wp_customize, 'theme_bg_color', array(
                    'label'             => __( 'Header and footer background color', 'portfolio'),
                    'section'           => 'colors',
	...
	// Add the controls
	$wp_customize->add_control(
		new WP_Customize_Color_Control( $wp_customize, 'interactive_color', array(
                    'label'             => __( 'Interactive color (links etc)', 'portfolio' ),
                    'section'           => 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			...
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'portfolio' )
		));
	...
	$wp_customize->add_setting( 'length_setting',
		array(
			'default'	=> 'excerpt',
			'type'		=> 'theme_mod',
			'sanitize_callback' => 'portfolio_sanitize_length', // Sanitization function appears further down
			'transport'	=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control( 'portfolio_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'portfolio' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
                            'excerpt'       => __( 'Excerpt (default)', 'portfolio' ),
                            'full-content'  => __( 'Full content', 'portfolio' )
                            ),
...
function portfolio_customize_preview_js() {
	wp_enqueue_script( 'portfolio_customizer', get_template_directory_uri() . '/js/customizer.js', array( 
...
function portfolio_sanitize_length( $value ) {

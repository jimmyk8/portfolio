...
<header class="page-header">
	<h1 class="page-title">
		<?php
		if ( is_404() ) { esc_html_e( 'Page not available', 'portfolio' );
		} else if ( is_search() ) {
			/* translators: %s = search query */
			printf( esc_html__( 'Nothing found for &ldquo;%s&rdquo;', 'portfolio'), get_search_query() );
		} else {
			esc_html_e( 'Nothing Found', 'portfolio' );
		}
		?>
	</h1>
</header><!-- .page-header -->
	...
	<main id="main" class="site-main" role="main">
		...
		<div class="page-content">
			...
			<?php elseif ( is_404() ) : ?>
				...
				<p><?php esc_html_e( 'You seem to be lost. To find what you are looking for check out the most recent articles below or try a search:', 'portfolio' ); ?></p>
				<?php get_search_form(); ?>
		...
		if ( is_404() || is_search() ) {
		?>
			<h2 class="page-title secondary-title"><?php esc_html_e( 'Most recent posts:', 'portfolio' ); ?></h2>
			<?php
